...
bash ${dir_here}/redhat-install-dev-tools.sh
su -c "bash ${dir_here}/redhat-install-pyenv.sh" ec2-user
bash ${dir_here}/redhat-install-c-compiler.sh
su -c "bash ${dir_here}/redhat-install-python.sh" ec2-user
